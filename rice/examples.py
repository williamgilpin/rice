...
def ecoli100():
    ...
    """
    amat = np.loadtxt("./data/ecoli100genes0_adjmat.csv.gz")
    X = np.loadtxt("./data/ecoli100genes0_X.csv.gz")
    return X, amat
...
def ecoli10():
    ...
    Returns:
        ...
        amat: the adjacency matrix of the true causal graph, shape (n_genes, n_genes)
    """
    amat = np.loadtxt("./data/ecoli10genes0_adjmat.csv.gz")
    X = np.loadtxt("./data/ecoli10genes0_X.csv.gz")
    return X, amat